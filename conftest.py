...
def pytest_addoption(parser):
    parser.addoption("--type", action="store", default="", help="consensus type")

# single及pow共识只有基本功能的测试，这里合并，有需要可以拆分
class SPTest:
...
# 指定scope为session，即所有测试文件共用一个input实例
